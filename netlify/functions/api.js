...
function enrichPermission(p, db) {
  const w =
    db.workers.find(x => x.id === p.worker_id) || {};
...
exports.handler = async event => {
  ...
  try {
    ...
    /* =====================================================
       ...
       Lo pasa a INACTIVO para conservar
       historial, permisos y asistencias.
    ===================================================== */
